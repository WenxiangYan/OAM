%% OAM for vortex-free self-accelerating beams with the enclosed spiral trajectory in Fig.3(A-D)
clear  
clc;
%% Basic parameter  
wave_length=532e-9;
...
%% Theoretical predictions of global OAM by Eq.(5)
num=401; z1=linspace(-f,f,num); t=z1/f+1; 
S0=0.1038e-3;gt=cos(2*pi*t);ht=sin(2*pi*t);%the enclosed spiral trajectory in Fig.3(A-D)
...
if ii == 1
name=' spirally self-accelerating Bessel-like beam with uniform intensity profile.gif';
